...
(function(){
    ...
    var initUser = function(){
        ...
        $('.input-group.search .input-group-append').on('click',function(){
        	var searchText = $('.input-group.search .form-control').val();
        	location.href = '/main/index?s='+searchText
        })
        $('.input-group.search .form-control').keydown(function(e){
        	if(e.keyCode === 13){
        		var searchText = $('.input-group.search .form-control').val();
        		location.href = '/main/index?s='+searchText
        	}
        ...
        if(!userInfo){
			...
			$(userInfoBox).find('.user-index').attr('href','/main/user?username='+userInfo.username)
